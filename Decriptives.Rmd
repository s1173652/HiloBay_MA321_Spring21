...
this is hard to see what is going on 
```{r}
RiverFlowexp2 <- ggplot(hilomodified,  aes(x = date, y = as.numeric(logcms))) + 
  geom_line()+
  geom_line(aes(y = as.numeric(saltppt)), color = "darkred") +
  geom_line(aes(y = as.numeric(Corr.NTU)), color="steelblue") +
  geom_line(aes(y=as.numeric(ChlRFU)),color="springgreen")

print(RiverFlowexp2 + ggtitle("River Flow")+labs(x="Time", y = "River Flow - cubic meters per second"))

RiverFlowexp2+ylim(0,45)
```
...
R2013.1 <- ggplot(hilo2013[1:(length(hilo2013[,1])/2),],  aes(x = date, y = as.numeric(cms))) + 
  ...
  geom_line(aes(y = as.numeric(Corr.NTU)), color="purple1") +
  geom_line(aes(y=as.numeric(ChlRFU)),color="cyan4")
...
R2013 <- ggplot(hilo2013,  aes(x = date, y = as.numeric(cms))) + 
  geom_line(color="black")+
  geom_line(aes(y = as.numeric(saltppt)), color = "lightsteelblue1") +
  geom_line(aes(y = as.numeric(Corr.NTU)), color="grey69") +
  geom_line(aes(y=as.numeric(ChlRFU)),color="khaki")

print(R2013 + ggtitle("River Flow")+labs(x="Time", y = "River Flow - cubic meters per second"))
```
# 2014
```{r}
...
print(R2014 + ggtitle("River Flow")+labs(x="Time", y = "River Flow - cubic meters per second"))
```
...
print(R2015 + ggtitle("River Flow")+labs(x="Time", y = "River Flow - cubic meters per second"))
```
