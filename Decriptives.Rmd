...
par(mfrow=c(6,1))
plot(x = date,y = as.numeric(hilomodified$cms[index]), type = "l",lwd=2, col="black", xlab="Time", ylab="River Flow cms", cex.lab = 5) # Create first plot for River Flow
text(x= enddate, y = endcms, col = "black", adj=1, cex=9, label= "River Flow")

plot(x = date ,y = as.numeric(hilomodified$ChlRFU[index]), type = "l",lwd=2, col="blue", xlab = "Time", ylab = "Chlorophyll  - relative fluorescence units (RFU)", cex.lab = 5)
text(x= enddate, y = endchl, col = "blue", adj=1, cex=9, label= "Chlorophyll")

plot(x = date ,y = as.numeric(hilomodified$Corr.NTU[index]), type = "l",lwd=2, col="red", xlab= "Time", ylab = "Turbidity - Nephelometric Turbidity Units (NTU)",cex.lab = 5)
text(x= enddate, y = endturb, col = "red", adj=1, cex=9, label= "Turbidity")

plot(x = date ,y = as.numeric(hilomodified$saltppt[index]), type = "l",lwd=2, col="green", xlab = "Time", ylab="Salinity - unit parts per thousand (PPT)", cex.lab = 5)
text(x = enddate, y = endsalt, col = "green", adj=1, cex=9, label= "Salinity")

plot(x = date ,y = as.numeric(hilomodified$TempC[index]), type = "l",lwd=2, col="orange", xlab="Time", ylab = "Temperature - Celsius" , cex.lab = 5)
text(x= enddate, y = endtemp, col = "orange", adj=1, cex=9, label= "Temperature")

if(sum(is.na(as.numeric(hilomodified$Doper[index])))==length(hilomodified$Doper[index])){
  plot(x = 0 ,y = 0, type = "l",lwd=2, col="purple", xlab= "Time", ylab = "Dissolved Oxygen in percent of saturation", cex.lab = 5)
text(x = 0, y = 0, col = "purple", adj=1, cex=9, label= "Dissolved Oxygen")
}else{
plot(x = date ,y = as.numeric(hilomodified$Doper[index]), type = "l",lwd=2, col="purple", xlab= "Time", ylab = "Dissolved Oxygen in percent of saturation", cex.lab = 5)
text(x = enddate, y = endDO, col = "purple", adj=1, cex=9, label= "Dissolved Oxygen")
}
}
...
DO <- as.numeric(hilomodified$Doper[index])
